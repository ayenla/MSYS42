# Generated by Django 5.2 on 2025-04-16 08:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Child',
            fields=[
                ('spc_code', models.CharField(max_length=7, primary_key=True, serialize=False, unique=True, validators=[django.core.validators.RegexValidator(regex='^[A-Za-z]{3}\\d{4}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spc_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='annual_medical_checks', to='msys42app.child')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=6)),
                ('spc_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='msys42app.child')),
            ],
            options={
                'db_table': 'fam_member',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spc_code', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='msys42app.child')),
            ],
            options={
